...
/*
Top 10 highest-paying remote Data Analyst roles (salary_year_avg):
    ...
    5) Data Analyst (Hybrid/Remote) — UCLA Health Careers — $217,000
    6) Principal Data Analyst (Remote) — SmartAsset — $205,000
    7) Director, Data Analyst (Hybrid) — Inclusively — $189,309
    8) Principal DA, AV Performance Analysis — Motional — $189,000
    9) Principal Data Analyst — SmartAsset — $186,000
    10) ERM Data Analyst — Get It Recruit – IT — $184,000

Takeaway: Remote top-pay spans ~$184k–$650k, skewing toward senior/lead titles (Director/Principal) with a few IC analyst roles at the very top.
